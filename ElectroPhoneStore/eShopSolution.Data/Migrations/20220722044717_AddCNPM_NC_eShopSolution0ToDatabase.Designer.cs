...
namespace eShopSolution.Data.Migrations
{
    ...
    [Migration("20220722044717_AddCNPM_NC_eShopSolution0ToDatabase")]
    partial class AddCNPM_NC_eShopSolution0ToDatabase
    {
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "eca34b59-5c5c-4d1b-b509-2e21c7e2acfd",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "01896cd4-69ef-484c-b78f-ab0794e9b2ec",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENV4acdxtwFQ+n+/DF/NTDqRV9UhkIKUjbQMsYY/Kbd6Oggc5HdwOBy1pgy6BHCjUA==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 707, DateTimeKind.Local).AddTicks(3514),
                            Description = "",
                            Details = "",
                            Name = "Áo nam 1",
                            Price = 28890000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 711, DateTimeKind.Local).AddTicks(4431),
                            Description = "",
                            Details = "",
                            Name = "Áo nữ 2",
                            Price = 20990000m,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 711, DateTimeKind.Local).AddTicks(4496),
                            Description = "",
                            Details = "",
                            Name = "Quần nam 1",
                            Price = 8290000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 711, DateTimeKind.Local).AddTicks(4499),
                            Description = "",
                            Details = "",
                            Name = "Quần nữ 2",
                            Price = 9990000m,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 5,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 711, DateTimeKind.Local).AddTicks(4502),
                            Description = "",
                            Details = "",
                            Name = "Trang phục 1",
                            Price = 5090000m,
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 6,
                            DateCreated = new DateTime(2022, 7, 22, 11, 47, 16, 711, DateTimeKind.Local).AddTicks(4504),
                            Description = "",
                            Details = "",
